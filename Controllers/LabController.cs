...
public class LabController : ControllerBase  // Ganti nama dari RuanganController
{
    private readonly IRuanganService _ruanganService;
    private readonly ILogger<LabController> _logger;

    public LabController(IRuanganService ruanganService, ILogger<LabController> logger)
    {
